  ...
  return (
    <div className="w-full max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500 text-[#473a87]">
      {isCreatingCourt ? (
        ...
        <div className="flex flex-col items-center justify-center p-20 text-[#473a87]/40 space-y-6">
          <h2 className="text-3xl font-bold text-[#473a87]/70">Admin Dashboard</h2>
          <p>Admin tools and settings will appear here.</p>
          <button
            onClick={() => setIsCreatingCourt(true)}
            className="mt-4 px-8 py-4 bg-[#473a87] text-white font-bold rounded-xl shadow-md hover:bg-[#382d6b] hover:shadow-lg transition-all focus:ring-4 focus:ring-[#473a87]/30"
          >
            Create a court
          </button>
        </div>
